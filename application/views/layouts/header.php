		...
		<div class="container">
			<div class="alignR">
				...
				<a href=""><span class="icon-envelope"></span> Contact us</a>
                                <a href="<?php echo base_url();?>inicio/carrito"><span class="icon-shopping-cart"></span> {{totalarticulos}} Item(s) - <span class="badge badge-warning"> $ {{totalapagar}}</span></a>
			</div>
		</div>
	</div>
</div>
	  ...
	  <div class="navbar-inner">
		<div class="container">
		  ...
		  <div class="nav-collapse">
			<ul class="nav">
			  <li ng-click="mostrarproductos()" class=""><a href="">Inicio</a></li>
			  
			</ul>
			<form action="#" class="navbar-search pull-right">
			  <input type="text" placeholder="Buscar" class="search-query span2" ng-model="buscar">
			</form>
